...
export class MultiplicationTaskGenerator implements QuizTaskGenerator<MultiplicationProblem> {
    private usedCombinations = new Set<string>();
    private readonly minNumber = 2;
    private readonly maxNumber = 10;

    generateNewProblem(): MultiplicationProblem {
        let availableCombinations: [number, number][] = [];
